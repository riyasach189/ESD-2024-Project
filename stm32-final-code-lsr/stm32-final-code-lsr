//ultrasonic
const int trigPinLeft = PA0;
const int echoPinLeft = PA14;
const int trigPinStraight = PC_12;
const int echoPinStraight = PC_10;
const int trigPinRight = PC_8;
const int echoPinRight = PC_6;
...
//motors
const int speedControlPinLeft = PA_0;          
const int speedControlPinRight = PA_1;
const int directionPinLeft1 = PB_3;
const int directionPinLeft2 = PB_5;
const int directionPinRight1 = PB_14;
const int directionPinRight2 = PB_4;
